...
opts.lite = true ;
opts.numTrain = 40; % 100 per class: 40 for training & 60 for testing
opts.numTest = 60;
opts.numVal = 0;
opts.seed = 1 ;
opts.variant = 'fmd' ;
